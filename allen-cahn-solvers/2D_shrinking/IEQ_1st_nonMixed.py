...
for epsilon in [0.16,0.08,0.04]:#,0.04,0.08,0.16]:
    ...
    for grid_point in [512]:
        for dt in [0.002]: #,0.3,0.4,0.5,0.6,0.7,0.8,0.9,1.0]:
            ...
            #======== Output parameters======
            write_file_name1 = "non_mixed_bdf1_2D_radius_"+str(epsilon)+'.txt'
            write_file_name2 = "non_mixed_bdf1_2D_ts_"+str(epsilon)+'.txt'
            fig_folder_name = "non_mixed_bdf1"+str(epsilon)
            write_frequency = 1
            write_to_file = True 
            save_figure = True
